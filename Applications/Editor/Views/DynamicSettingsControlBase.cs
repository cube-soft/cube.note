...
namespace Cube.Note.App.Editor
{
    ...
    ///
    /* --------------------------------------------------------------------- */
    public class DynamicSettingsControlBase : Cube.Forms.ControlBase
    {
        #region Constructors
        ...
        ///
        /* ----------------------------------------------------------------- */
        public DynamicSettingsControlBase() : base() { }
        ...
        ///
        /* ----------------------------------------------------------------- */
        public DynamicSettingsControlBase(Control ok, Control cancel, Control apply = null) : base()
        {
            OKButton     = ok;
            CancelButton = cancel;
            ApplyButton  = apply;
        ...
        {
            var control = sender as Cube.Forms.ColorButton;
            if (control == null) return;
        ...
        {
            var control = sender as Cube.Forms.FontButton;
            if (control == null) return;
        ...
        ///
        /* ----------------------------------------------------------------- */
        private void UpdateColorButton(Cube.Forms.ColorButton control, Color? value)
        {
        ...
        ///
        /* ----------------------------------------------------------------- */
        private void UpdateFontButton(Cube.Forms.FontButton control, Font value)
        {
